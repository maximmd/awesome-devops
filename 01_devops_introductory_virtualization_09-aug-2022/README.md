...
- Download and add [Rocky 8 Linux distribution ISO](https://download.rockylinux.org/pub/rocky/9/isos/x86_64/Rocky-9.4-x86_64-minimal.iso) to Proxmox default storage location:
